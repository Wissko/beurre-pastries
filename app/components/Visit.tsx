...
export default function Visit() {
  ...
  const infoItems = [
    {
      label: 'Location',
      value: 'Park Road, Milton, Brisbane\nAcross from La Dolce Vita',
    },
    {
      label: 'Coffee',
      value: 'Bear Bones Coffee',
    },
    {
      label: 'Hours',
              ...
              {status === 'success' ? (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ fontSize: '26px', color: 'var(--color-dark)', fontWeight: 300 }}
                  >
                    Message sent.
                  </div>
                  <p
                  ...
                  {[
                    ...
                    >
                      <label
                        ...
                        style={{ fontSize: '8px', letterSpacing: '0.24em', color: 'var(--color-muted)', fontWeight: 300 }}
                      >
                        {field.label}
                      </label>
